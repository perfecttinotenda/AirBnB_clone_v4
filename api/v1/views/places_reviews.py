#!/usr/bin/python3
'''This will contain the places_reviews view for our API.'''
...
def handle_reviews(place_id=None, review_id=None):
    '''Our method handler of reviews endpoint.'''
    handlers = {
        'GET': get_reviews,
...
def get_reviews(place_id=None, review_id=None):
    '''This will get a review per given id or all reviews in the place per given id.'''
    if place_id:
...
def remove_review(place_id=None, review_id=None):
    '''This will remove a review per given id.'''
    review = storage.get(Review, review_id)
    if review:
...
def update_review(place_id=None, review_id=None):
    '''This will update a review per given id.'''
